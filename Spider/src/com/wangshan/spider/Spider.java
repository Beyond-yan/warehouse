...
public class Spider {
	...
	public static String path = "http://www.cqjt.gov.cn/";	//交委政务外网
	...
	public static void getAllLinks(String path){
		...
		//同时抓取该页面图片链接
		for(Element elements:imgLinks){
			String srcStr = elements.attr("src");
	...
	public static void main(String[] args) {
		aLinkFile = new File("E:/Spider/ALinks.txt");
		imgLinkFile = new File("/E:/Spider/ImgLinks.txt");	
		docLinkFile = new File("E:/Spider/DocLinks.txt");
		errorLinkFile = new File("E:/Spider/ErrorLinks.txt");
...
/*
	...
	https://blog.csdn.net/qq_38777773/article/details/79533393
